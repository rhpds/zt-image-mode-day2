== A word about tags
=== _Return to the `Builder` tab for this exercise._
...
Add the following line at the end of the file using vim:
...
=== _Switch to the `Image mode host` tab to apply the update._
